#ifndef cutsAndBinChiB_C
#define cutsAndBinChiB_C
...
struct ParticleMass { double JPsi, Psi2S, Y1S, Y2S, Y3S, Z, PiPlus, KaPlus, Chic1, Chic2, Chib1, Chib2;};
ParticleMass pdgMass = {3.096, 3.686, 9.460, 10.023, 10.355, 91.188, 0.139570, 0.49367,3.51066, 3.55620, 9.89278, 9.91221};
...
TString getKineLabel(float ptLow, float ptHigh, float yLow, float yHigh, int ntrkLow, int ntrkHigh) {
  TString kineLabel = Form("pt%.1f-%.1f_y%.1f-%.1f",ptLow,ptHigh, yLow, yHigh) ;
    kineLabel = kineLabel+ Form("_nTracks%d-%d",(int)ntrkLow, (int)ntrkHigh) ;
  return kineLabel;
}

TString getKineLabelSiMuPt(float ptLow, float ptHigh, float yLow, float yHigh, float SiMuPtCut, int ntrkLow, int ntrkHigh) {
  TString kineLabel = Form("pt%.1f-%.1f_y%.1f-%.1f_SiMuPt%.1f",ptLow,ptHigh, yLow, yHigh, SiMuPtCut) ;
    kineLabel = kineLabel+ Form("_nTracks%d-%d",(int)ntrkLow, (int)ntrkHigh) ;
  return kineLabel;
}
